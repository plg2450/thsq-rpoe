...
from ..dialogs import show_question, ask_text
...
class ProfileCard(QFrame):
    ...
    def __init__(self, profile_id: str, name: str, duration: float, is_active: bool = False, parent=None):
        ...
        self.setProperty("class", "profileCard active" if is_active else "profileCard")
        self._setup_ui()
    ...
    def _setup_ui(self):
        ...
        self.name_label.setProperty("class", "profileName")
        ...
        self.duration_label.setProperty("class", "profileDuration")
        layout.addWidget(self.duration_label)

        self.use_btn = QPushButton("使用")
        self.use_btn.setFixedHeight(24)
        self.use_btn.setProperty("class", "profileUseBtn")
    ...
    def set_active(self, active: bool):
        ...
        self.setProperty("class", "profileCard active" if active else "profileCard")
    ...
    def mousePressEvent(self, event):
        if event.button() == Qt.RightButton:
            ...
            if action == rename_action:
                new_name, ok = ask_text(self, "重命名", "输入新名称:", self._name)
                if ok and new_name:
...
class VoiceProfileSelector(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.new_btn.setProperty("class", "newProfileBtn")
